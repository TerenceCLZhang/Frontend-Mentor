...
const Nav = () => {
  ...
  return (
    <nav className="absolute z-10 padding w-full lg:static lg:pt-20 lg:flex gap-10 lg:gap-0 lg:justify-between">
      ...
      {isMenuOpen && (
        <ul className="mt-8 bg-white p-8 rounded-md flex flex-col justify-center items-center gap-5 shadow-2xl lg:hidden">
      ...
      <ul className="hidden lg:flex items-center justify-between w-[85%]">
